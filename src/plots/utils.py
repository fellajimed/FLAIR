...
def fig_subplots(number_plots: int, nrows: int | None = None,
                 ncols: int | None = None,
                 fig: Figure | None = None,
                 figsize: tuple[int] = (16, 9),
                 axsize: tuple[int] | None = None,
                 ) -> tuple[Figure, np.ndarray[plt.Axes]]:
    """
...
def figure_axes(number_plots: int, fig: Figure | None = None,
                figsize: tuple[int] = (16, 9),
                ) -> tuple[Figure, np.ndarray[plt.Axes]]:
    """
